...
import sys
import os
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../'))) #fix path for deployment in render
...
class NewsletterGenUI:
    ...
    def newsletter_generation(self):
        ...
        # st.session_state.newsletter = "" # for debugging
    ...
    def sidebar(self):
        with st.sidebar:
            ...
            st.text_input("Topic", key="topic", placeholder="Dutch Breaking News")
